...
{ 
    if( ($rbtnUpload.Checked -eq $true)) {
        ...
        Write-Host "Copying the outlookArchive.zip file to C:\Users\$env:UserName\OneDrive"
        Copy-Item -Path "C:\Users\$env:UserName\AppData\Local\Microsoft\Outlook\outlookArchive.zip" -Destination "C:\Users\$env:UserName\OneDrive"
        ...
        $origName = @()
        Write-Host "Copying outlookArchive.zip from C:\Users\$env:UserName\OneDrive"
        Copy-Item -Path "C:\Users\$env:UserName\OneDrive\outlookArchive.zip" -Destination "C:\Users\$env:UserName\Documents\Outlook Files\"
        Remove-Item -Path "C:\Users\$env:UserName\OneDrive\outlookArchive.zip"
